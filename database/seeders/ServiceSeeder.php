    ...
    public function run(): void {
        ...
        foreach ( $services as $serviceData ) {
            Service::create( [
                ...
                // Lo slug viene generato automaticamente dal modello Service se hai il mutator setNameAttribute
            ] );
        }

        // Opzionale: genera alcuni servizi aggiuntivi fittizi usando la factory

        // if (app()->environment('local', 'development')) { // Solo in ambienti di sviluppo
