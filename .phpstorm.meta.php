...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\pimel\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\pimel\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'home','blog.index','blog.show','servizi.index',
'pages.about','contatti.form','newsletter.form','contatti.store','newsletter.subscribe',
...
'auth.verify-email','blog.index','blog.show','chi-sono','components.application-logo',
'components.auth-session-status','components.danger-button','components.dropdown','components.dropdown-link','components.home.hero-section',
'components.home.latest-articles','components.input-error','components.input-label','components.layout.footer','components.layout.header',
...
'components.shared.newsletter-card','components.text-input','contatti.form','dashboard','home',
'layouts.app','layouts.guest','layouts.navigation','newsletter.form','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','servizi.index','laravel-exceptions-renderer::components.card',
