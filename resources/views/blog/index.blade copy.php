                ...
                <section class="container mt-4 mb-4">
                    <div class="row">
                        <div class="col-12"> {{-- Assicurati che occupi tutta la larghezza per il justify-content --}}
                            <div id="rubric-filter-group"
                                class="btn-group flex-wrap justify-content-start rubric-filter-buttons" role="group"
                                aria-label="Filtra per rubrica">
                                {{-- Opzione "Tutte le Rubriche" --}}
                          
                                
                                    <input type="radio" class="btn-check" name="rubric_filter" id="rubric_all"
                                        value="" autocomplete="off" {{ !$selectedRubricSlug ? 'checked' : '' }}>
